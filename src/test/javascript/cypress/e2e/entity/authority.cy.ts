...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'db4b42f9-cd36-4765-8b3e-df94f31f73cd' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('2f0e1523-dbec-43c9-9413-9790f57a2ccb');
      cy.get(`[data-cy="name"]`).should('have.value', '2f0e1523-dbec-43c9-9413-9790f57a2ccb');
